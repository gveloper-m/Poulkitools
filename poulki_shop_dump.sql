-- Poulki Shop Database Dump
-- Complete database schema with default data
-- Import this file in Plesk phpMyAdmin

-- =====================================================
-- DROP EXISTING DATABASE (Optional - uncomment if needed)
-- =====================================================
-- DROP DATABASE IF EXISTS `poulki_shop`;

-- =====================================================
-- CREATE DATABASE
-- =====================================================
CREATE DATABASE IF NOT EXISTS `poulki_shop` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `poulki_shop`;
...
-- Next steps:
-- 1. Upload all PHP files to backend/
-- 2. Upload migrations folder
-- 3. Upload assets folder (CSS, JS, images)
-- 4. Set uploads/ folder permissions to 755-777
-- 5. Visit homepage to trigger auto-migrations
