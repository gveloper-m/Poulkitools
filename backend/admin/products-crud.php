...
try {
    ...
    elseif ($method === 'POST' && isset($_POST['_method']) && $_POST['_method'] === 'PUT') {
        // Update product (check this before general POST to avoid validation)
        $id = $_POST['id'] ?? null;
    ...
    elseif ($method === 'POST' && isset($_POST['_method']) && $_POST['_method'] === 'DELETE') {
        // Delete product (check this before general POST to avoid validation)
        $id = $_POST['id'] ?? null;
    ...
    elseif ($method === 'POST') {
        ...
        $stmt = $pdo->prepare("INSERT INTO products 
            (unique_id, name, description, model, link, image, category, cat_id, price_with_vat, 
             thursday_price, manufacturer, mpa, gan, weight, instock, quantity, source) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'manual')");
